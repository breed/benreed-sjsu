...
- dynamo: <https://www.allthingsdistributed.com/files/amazon-dynamo-sosp2007.pdf> - an interesting example of relaxing requirements to solve a practical problem. i am bitter than they broke the term "eventual consistency"...
...
- raft: <https://web.stanford.edu/~ouster/cgi-bin/papers/raft-atc14> - a relatively recent atomic broadcast algorithm. it brings back some of the concepts of an earlier paper on view stamped replication. people lump it in with paxos, but it has some very important differences, especially to engineers. it also gets you closer to where you want to be: paxos gets a decision made, raft does that and ensures that it is propogated.
...
- flexible quorum systems: <https://arxiv.org/pdf/1608.06696v1.pdf> - a nice, if impractical, way of lookign at quorum systems. it gives great insight into the different phases of some consensus algorithms.
